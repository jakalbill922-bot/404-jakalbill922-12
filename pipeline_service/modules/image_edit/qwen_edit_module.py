...
class QwenEditModule(QwenManager):
    ...
    def _set_text_prompting(self, path: Optional[PathLike] = None) -> TextPrompting:
        ...
        with open(path, "r") as f:
            ...
            if not isinstance(data, Iterable):
                data = (data,)
            edit_prompt = tuple(TextPrompting.model_validate(d) for d in data)
            return edit_prompt
    ...
    def edit_image(self, prompt_image: Image.Image, seed: int):
        ...
        try:
            ...
            promptings = self.prompting if isinstance(self.prompting, Iterable) else (self.prompting,)
